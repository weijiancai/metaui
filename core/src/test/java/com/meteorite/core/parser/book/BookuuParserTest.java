...
import com.metaui.core.parser.book.BookuuParser;
...
public class BookuuParserTest {
    ...
    public void testParse() throws Exception {
        ...
        assertThat(product.getPrice(), equalTo("46.00"));
        ...
        assertThat(product.getWordCount(), equalTo("197"));
        ...
        assertThat(product.getPack(), equalTo("平装"));
    }
