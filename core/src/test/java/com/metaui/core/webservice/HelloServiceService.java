 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservice.core.metaui.com/", wsdlLocation = "http://localhost:9001/Service/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservice.core.metaui.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservice.core.metaui.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.core.metaui.com/", "HelloServicePort"), HelloService.class, features);
    }
