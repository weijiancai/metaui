 ...
 * generated in the com.metaui.core.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://webservice.core.metaui.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://webservice.core.metaui.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.metaui.core.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.core.metaui.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.core.metaui.com/", name = "getValue")
