...
import static com.metaui.core.config.SystemConfig.SYSTEM_TYPE;
...
public class PathManager {
     ...
     * @return 返回File对象
     */
    public static File getModulePath(String moduleName) {
        File file = new File(getHomePath(), moduleName);
        if (!file.exists()) {
            file.mkdirs();
        }
        return file;
